...
contract BaseScript is Script {
    ...
    // --- Configure These ---
    /////////////////////////////////////
    IERC20 internal constant token0 = IERC20(0x6d521a93A3B1fEF995026eBD537405EBD4A1E481);
    IERC20 internal constant token1 = IERC20(0x00571860bB39C639e8aAD55B4E95D36BE228ae11);
    IHooks constant hookContract = IHooks(address(0x75c4cD5D01368F89E4957e67867275DDEBE740C0));
    /////////////////////////////////////
    ...
    constructor() {
        ...
        // deployed V4Router for Arbitrum Sepolia
        if (block.chainid == 421614) {
            swapRouter = IUniswapV4Router04(payable(0xCD0b7d5ECd5279D946F99d98633E1942893C3573));
        } else {
