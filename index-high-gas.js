...
// High gas limit paymaster configuration
const paymaster = {
  async getPaymasterData(parameters) {
    ...
    return {
      ...
      paymasterData,
      paymasterVerificationGasLimit: 1000000n, // 1M gas for complex operations
      paymasterPostOpGasLimit: 100000n, // 100k gas for post-op
      isFinal: true,
    };
  },
};

// Create bundler client with high gas limits
...
console.log("Sending user operation with HIGH gas limits...");
...
const hash = await bundlerClient.sendUserOperation({
  ...
  // High gas limits for complex operations
  verificationGasLimit: 1000000n, // 1M gas for verification
  callGasLimit: 500000n, // 500k gas for call execution
