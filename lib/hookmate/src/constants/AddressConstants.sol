...
library AddressConstants {
    ...
    function getPoolManagerAddress(uint256 chainId) internal pure returns (address) {
        ...
        if (chainId == 31337) {
            return address(0x5FbDB2315678afecb367f032d93F642f64180aa3); // Local Anvil
        }
    ...
    function getPositionManagerAddress(uint256 chainId) internal pure returns (address) {
        ...
        if (chainId == 31337) {
            return address(0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512); // Local Anvil
        }
    ...
    function getV4SwapRouterAddress(uint256 chainId) internal pure returns (address) {
        ...
        if (chainId == 421614) {
            return address(0x00000000000044a361Ae3cAc094c9D1b14Eece97); // Arbitrum Sepolia
        }
